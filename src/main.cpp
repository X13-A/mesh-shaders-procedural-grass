...
void App::init() {
    ...
    grassField.modelMatrix = glm::translate(glm::mat4(1), glm::vec3(5, 0, 0));
    //grassField.modelMatrix = glm::rotate(grassField.modelMatrix, glm::radians(-45.0f), glm::vec3(1, 0, 0));
